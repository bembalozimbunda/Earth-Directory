      ...
      const interval = setInterval(() => {
        setScanProgress(prev => {
          if (prev >= 100) {
            ...
            setTimeout(() => setStage('identified'), 500);
            return 100;
          }
          return prev + 2;
        });
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="border border-zinc-800/50 bg-zinc-900/40 p-6 rounded-lg flex flex-col">
                    ...
                    <button
                      ...
                      className="mt-auto w-full py-4 bg-emerald-500/10 border border-emerald-500/50 hover:bg-emerald-500/20 hover:border-emerald-500 text-emerald-400 font-mono text-sm uppercase tracking-widest transition-all rounded"
                    >
            ...
            {stage === 'scanning' && (
              ...
              >
                <div className="relative mb-8">
                  ...
                  <motion.div 
                    className="absolute top-0 left-0 w-full h-1 bg-emerald-400 shadow-[0_0_20px_rgba(16,185,129,1)]"
                    animate={{ y: [0, 128, 0] }}
              ...
              >
                ...
                <div className="flex justify-center mt-4">
                  <button
                    ...
                    className="px-6 py-2 border border-zinc-700 hover:border-emerald-500 text-zinc-400 hover:text-emerald-400 font-mono text-xs uppercase tracking-widest transition-colors rounded"
                  >
                    Reset Vision
                  </button>
                </div>
