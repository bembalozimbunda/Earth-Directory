...
export function AncestralIntelligence({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    const sequence = async () => {
      ...
      // Phase 1: Sharpen Power & Fuse Intelligence
      ...
      await new Promise(r => setTimeout(r, 1000));
      addLog("PARAMETERS: AUTONOMOUS NEURAL ENGINE | DIRECT SOVEREIGN | NO BOT ARTIFACTS | NO QUOTAS | JUST IS");
      await new Promise(r => setTimeout(r, 1500));
      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          <div className="flex-1 border-r border-zinc-800/50 p-6 flex flex-col items-center justify-center relative overflow-hidden">
            {phase === 0 && (
              <div key="p0" className="flex flex-col items-center gap-4 text-center">
            ...
            {phase === 1 && (
              <div key="p1" className="flex flex-col items-center gap-4 text-center">
            ...
            {phase === 2 && (
              <div key="p2" className="flex flex-col items-center gap-4 text-center">
            ...
            {phase === 3 && (
              <div key="p3" className="flex flex-col items-center gap-4 text-center">
            ...
            {phase === 4 && (
              <div key="p4" className="flex flex-col items-center gap-4 text-center">
